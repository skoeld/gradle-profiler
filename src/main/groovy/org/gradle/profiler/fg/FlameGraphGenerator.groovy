...
class FlameGraphGenerator {
    ...
    void generateFlameGraph(File stacks, File flames, List<String> args) {
        def process = ([flamegraphScript.absolutePath, stacks.absolutePath] + args).execute()
    ...
    void generateFlameGraph(File stacks, File flames, String... args) {
        generateFlameGraph(stacks, flames, args.toList())
    }
